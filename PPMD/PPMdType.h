...
#define FALSE 0
#define TRUE  1
typedef uint8_t  BYTE;                // it must be equal to uint8_t
typedef uint16_t WORD;                // it must be equal to uint16_t
typedef uint32_t  DWORD;                // it must be equal to uint32_t
typedef uint64_t QWORD;                // it must be equal to uint64_t
